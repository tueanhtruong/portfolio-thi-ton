      ...
      <Layout scrollOptions={webContentScrollOptions} endButton={endButton}>
        <Box sx={commonStyles.container}>
          ...
          <Heading as="p" sx={commonStyles.p}>
            ...
            responsible for auditing websites to optimize the search engine
            using Screaming Frog, Google Search Console, Surferseo, Ahrefs,
            etc., and making it user-friendly.{" "}
          </Heading>
          {/* ////////////////////////// GIFT IDEAS ////////////////////////// */}
          ...
          <Box sx={{ paddingTop: 80, marginTop: -80 }} id="wedding-planning">
            ...
            <Heading as="p" sx={{ ...commonStyles.p, color: "#877b58" }}>
              This article about Wedding Planning is on the PBN project. I am
              also responsible for creating the keyword plan for the whole
              website and ensuring all contents' quality including good
              information, internal links, external links, backlinks.
            </Heading>
            <Flex>
              <Button
                sx={{ margin: "16px auto 24px" }}
          ...
          <Box sx={{ paddingTop: 80, marginTop: -80 }} id="home-decor">
            ...
            <Heading as="p" sx={{ ...commonStyles.p, color: "#877b58" }}>
              This article about Home decor is the one that I generated during
              my internship time.
            </Heading>
            <Flex>
              <Button
          ...
          <Box sx={{ paddingTop: 80, marginTop: -80 }} id="finance">
            ...
            <Heading as="p" sx={{ ...commonStyles.p, color: "#877b58" }}>
              This article which is about Finance, is in a freelance project. As
              a result, I do not have the live URL. However, I saved all my
              freelance works on my laptop so I will show them via these PNG
              files below.
            </Heading>
            <Slide
              indicators={true}
