export default {
  ...
  colors: {
    text: "#597188", // body color and primary color
    text_secondary: "#02073E", // secondary body color
    heading: "#0F2137", // primary heading color
    heading_secondary: "#597188", // heading color
    background: "#F5F0EA", // body background color
    background_secondary: "#F9FBFD", // secondary background color
    border_color: "#E9EDF5", // border color
    primary: "#c89956", // primary button and link color
    primaryLight: "#c8995630",
    black: "#0F2137",
    secondary: "#877b58", // secondary color - can be used for hover states
