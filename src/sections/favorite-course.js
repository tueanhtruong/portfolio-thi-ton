...
const favoriteCourseData = [
  {
    title: "LumiSight, a remarkable milestone of DataHouse Asia in 2020",
    image: fevCardImageOne,
    reviewCount: "5.0 (392 reviews)",
    watchCount: "2,538 students watched",
    videoLink: "DcLErmpaD5g",
    starCount: 5,
  },
  // {
  //   title:
...
const FavoriteCourse = () => {
  ...
  return (
    <Box as="section" id="courses" sx={styles.fevCourse}>
      <Container sx={styles.fevCourse.container}>
        <BlockTitle
          sx={styles.fevCourse.blockTitle}
          tagline="LumiSight SaaS solutions"
          heading="Use our end-to-end applications to optimize your business."
        />
